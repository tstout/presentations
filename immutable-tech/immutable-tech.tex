...
% }
  ...
  \frame{
    ...
    \note { 
      \begin {itemize} 
      \item The protocols here define the foundation for how humanity 
           and machines communicate electronically
      \item No matter what type of software dev you are engaged in, details of these protocols
            will arise frequently in many contexts, including trouble shooting.
      \end {itemize}
    }  
  }
    ...
    \note{
      \begin{itemize}
        ...
        \item Even if you don't like unix shell scripting, there will always be production support
              ...
              intermediate level will server you well
      \end{itemize}
     }
    }
