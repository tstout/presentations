...
\begin{frame}
  ...
  \note{Developers are required to constantly learn new frameworks, platforms, 
...
\frame{
  ...
  \note{
    \begin{itemize}
      ...
      \item COM/DCOM - Fear of Microsoft at the time
...
\frame{
  ...
  \note{
    \begin{itemize}
      \item Data is very important - most enterprise software is focused on data processing
      \item Application stacks come and go, but data can live forever. In some cases, the older the data
            the more valuable it is.
      \item The native language of databases is some form of SQL.
